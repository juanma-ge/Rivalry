...
Para la fase de evaluación del proyecto, la aplicación se distribuye de forma directa mediante el empaquetado universal en formato **.APK (Android Package Kit)**, donde se facilita la descarga para los usuarios que no sean desarrolladores.

Lo puedes descargar directamente pulsando en el siguiente botón:

[![Descargar APK](https://img.shields.io/badge/ANDROID-DESCARGAR_APK-2ECC71?style=for-the-badge&logo=android&logoColor=white)](https://github.com/juanma-ge/Rivalry/releases/download/v1.0/Rivalry-v1.0.apk)
